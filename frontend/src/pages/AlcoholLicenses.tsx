...
const AlcoholLicenses: React.FC = () => {
    ...
    const columns: ColumnsType<Store> = [
        ...
        },
        {
            ...
            sorter: (a, b) => {
                if (!a.alcoholLicenseExpiry && !b.alcoholLicenseExpiry) return 0;
                if (!a.alcoholLicenseExpiry) return 1;
                if (!b.alcoholLicenseExpiry) return -1;
                return new Date(a.alcoholLicenseExpiry).getTime() - new Date(b.alcoholLicenseExpiry).getTime();
            },
...
export default AlcoholLicenses;
