...
const CreateTobaccoLicenseTask: React.FC = () => {
    ...
    const handleSubmit = async (values: any) => {
        try {
            message.success('Задача на получение табачной лицензии создана');
            navigate('/tasks');
        } catch (error) {
        ...
        <div style={{ padding: '16px', background: '#f0f2f5', minHeight: '100vh' }}>
            ...
            <div style={{ marginBottom: 16, background: '#fff', padding: '12px 16px', borderRadius: '8px', boxShadow: '0 1px 2px rgba(0,0,0,0.03)' }}>
                <Space align="center">
                    ...
                    <Title level={3} style={{ margin: 0 }}>Создание задачи на получение табачной лицензии</Title>
                </Space>
            </div>
                ...
                <Col span={8}>
                    ...
                    >
                        <div style={{ marginBottom: 16 }}>
                            ...
                            <div style={{ fontSize: '14px', fontWeight: 500 }}>Табачная продукция</div>
                        </div>
